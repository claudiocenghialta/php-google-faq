...
<body>
    ...
    <header>
        <div class="header-top">
            <img class="logo" src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_74x24dp.png" alt="Logo Google">
        ...
        <div class="header-bottom">
            <div class="header-bottom-left">
                ...
                <h2>Tecnologie</h2>
                <h2 class="active">Domande frequenti</h2>
            </div>
    ...
    <main>
        <div class="maxwidth">
            <?php
            foreach ($array as $sezione) {?>
                <h3><?php echo $sezione['title']; ?></h3>
                <?php foreach ($sezione['description'] as $paragrafo) {?>
